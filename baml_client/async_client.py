...
class BamlAsyncClient:
    ...
    async def BreakProblemsAndFindTools(
        self,
        user_message: str,
        baml_options: BamlCallOptions = {},
    ) -> List[types.SmallerProblems]:
      ...
      return cast(List[types.SmallerProblems], raw.cast_to(types, types, partial_types, False))
...
class BamlStreamClient:
    ...
    def BreakProblemsAndFindTools(
        self,
        user_message: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[List[partial_types.SmallerProblems], List[types.SmallerProblems]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[List[partial_types.SmallerProblems], List[types.SmallerProblems]](
        raw,
        lambda x: cast(List[partial_types.SmallerProblems], x.cast_to(types, types, partial_types, True)),
        lambda x: cast(List[types.SmallerProblems], x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
